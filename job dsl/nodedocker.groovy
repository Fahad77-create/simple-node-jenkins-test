job("node js project ver 2"){
    description("this project will clone node js proj and build and push it to docker hub")
     scm {
        git('https://fahad77-create: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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@github.com/fahad77-create/simple-node-jenkins-test.git','main') { node -> 
